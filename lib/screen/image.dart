...
//   const Imagescreen({super.key, DateTime selectedDate});
...
//               builder: (context) => UploadScreen(image: File(image.path))));
//         }
//       }
//     }
...
//           });
//           Navigator.of(context).push(MaterialPageRoute(
//               builder: (context) => UploadScreen(image: File(images.path))));
//         }
//       }
//     }
